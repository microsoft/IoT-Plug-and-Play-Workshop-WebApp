...
namespace Portal.Helper
{
    public class DTDLModelResolver
    {
        ...
        private static ILogger<DTDLModelResolver> _logger = null;

        public DTDLModelResolver(string repositoryUri, string githubToken, ILogger<DTDLModelResolver> logger)
        {
